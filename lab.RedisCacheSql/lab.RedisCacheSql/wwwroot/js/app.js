...
var App = function () {
    ...
    var isUserRoleAdmin = function (roleName) {
    ...
    var isUserRoleMember = function (roleName) {
    ...
    var isUserRoleReader = function (roleName) {

        if (roleName == appUserRole.ReaderUser) {
            return true;
        }
        else {
            return false;
    ...
    return {
        ...
        IsUserRoleMember: isUserRoleMember,
        IsUserRoleReader: isUserRoleReader,

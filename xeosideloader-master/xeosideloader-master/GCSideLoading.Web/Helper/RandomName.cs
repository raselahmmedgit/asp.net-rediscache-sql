...
namespace ConferenceGaming.Web.Helper
{
    /// <summary>
    ...
    public class RandomName
    {
        ...
        private static RandomName _randomname;
        public static RandomName Instance() {
            _randomname = _randomname == null ? new RandomName(new Random()) : _randomname;
            return _randomname;
        }
        /// <summary>
        ...
        {
            string filePath = GetApplicationPath("wwwroot\\jsondata\\names.json");
            this.rand = rand;

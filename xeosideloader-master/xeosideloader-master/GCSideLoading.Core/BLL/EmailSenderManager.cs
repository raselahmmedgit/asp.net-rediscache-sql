using GCSideLoading.Core.EmailSender;
...
namespace GCSideLoading.Core.BLL
{
    public class EmailSenderManager
    {
        ...
        public EmailSenderManager(IConfiguration configuration)
        {
            ...
            _emailConfiguration.FromEmailAddress = _configuration["GCSideLoadingEmailConfig:FromEmailAddressKey"].ToString();
            _emailConfiguration.DisplayName = _configuration["GCSideLoadingEmailConfig:DisplayNameKey"].ToString();
            _emailConfiguration.Password = _configuration["GCSideLoadingEmailConfig:PasswordKey"].ToString();
            _emailConfiguration.Host = _configuration["GCSideLoadingEmailConfig:HostKey"].ToString();
            _emailConfiguration.Port = Int32.Parse(_configuration["GCSideLoadingEmailConfig:PortKey"]);
            _emailConfiguration.Ssl = Boolean.Parse(_configuration["GCSideLoadingEmailConfig:SslKey"]);
            ...
            _sendGridConfiguration.FromEmailAddress = _configuration["GCSideLoadingEmailConfig:SendGridFromEmailAddressKey"].ToString();
            _sendGridConfiguration.DisplayName = _configuration["GCSideLoadingEmailConfig:SendGridDisplayNameKey"].ToString();
            _sendGridConfiguration.ApiKey = _configuration["GCSideLoadingEmailConfig:SendGridApiKey"].ToString();
